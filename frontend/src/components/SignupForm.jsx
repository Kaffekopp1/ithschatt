              ...
              <DialogHeader>
                ...
                <DialogDescription>
                  <p>
                    ...
                    förnamn, efternamn, e-postadress, användarnamn (och adress
                    och postnummer om det tillåts i registreringen). Syftet med
                    denna behandling är följande:
                  </p>

                  <ul>
                    <li>
                      <strong>1. Skapa och administrera användarkonton</strong>:
                      Vi samlar in personuppgifter, såsom användarnamn, förnamn
                      och efternamn, för att skapa och identifiera
                      användarkonton i vår chatt-applikation. Detta är
                      nödvändigt för att tillhandahålla en säker och funktionell
                      tjänst.
                    </li>
                    <li>
                      <strong>2. Kommunicera med användare</strong>: Vi använder
                      din e-postadress för att skicka viktig information, såsom
                      kontobekräftelser, lösenordsåterställningar eller
                      meddelanden relaterade till din aktivitet i applikationen.
                      Detta görs för att säkerställa en god användarupplevelse
                      och säkerhet.
                    </li>
                    <li>
                      ...
                      geografiskt anpassad information eller visa lokalanpassade
                      annonser baserat på din adress (om relevant).
                    </li>
                    <li>
                      <strong>
                      ...
                      användarkonton, förhindra otillåten åtkomst och
                  ...
                  <p>
                    ...
                    personuppgifter. Den rättsliga grunden för att behandla dina
                    uppgifter är ditt samtycke. Du har rätt att när som helst
                    återkalla ditt samtycke till behandlingen. Ett återkallande
                    påverkar inte lagligheten av behandlingen innan samtycket
                    återkallades. Dina uppgifter kommer att sparas i ett år
                    efter senaste aktivitet.
                  </p>
                  ...
                  <p>
                    ...
                    samband med att du använder vår chattfunktion. Vi delar inte
                    dina uppgifter med externa företag, myndigheter eller
                  ...
                  <p>
                    <strong>Överföring till tredje land:</strong> Vi kommer inte
                    att överföra dina uppgifter till ett land utanför EU. Alla
                    personuppgifter som vi behandlar lagras och behandlas på
                    servrar inom EU, och vi vidtar lämpliga säkerhetsåtgärder
                  ...
                  <p>
                    ...
                    IT-högskolan. Du har rätt att kontakta oss om du vill ta del
                    av information om de uppgifter vi har om dig, begära
                    rättelse, överföring eller att vi begränsar behandlingen av
                    dina uppgifter, eller om du vill göra invändningar eller
                    begära radering.
                  </p>

                  <p>
                    <strong>Kontaktinformation:</strong> Du kan kontakta oss på
                    IT-högskolan för dessa ändamål. Du når vårt dataskyddsombud
                    på:{' '}
